...
// Cleaned up version of https://github.com/sumneko/lua-language-server/wiki/EmmyLua-Libraries, stolen from https://github.com/Derpius/nanosworld-vscode/blob/master/src/extension.ts
...
export function deactivate(context: vscode.ExtensionContext) {
	...
	console.log("StarfallEx sumneko bindings unloaded");
}